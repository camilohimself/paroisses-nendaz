...
import { Heart, Church, Clock } from 'lucide-react'
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:order-last lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="space-y-4 text-sm">
                <div className="flex items-start gap-3">
                  <Clock className="w-6 h-6 text-stone-600 flex-shrink-0 mt-0.5" />
                  <div>
            ...
            {/* Contact CTA */}
            <div className="bg-gradient-to-br from-stone-600 to-amber-700 text-white rounded-xl shadow-lg p-6 lg:sticky lg:top-6">
