export default function ContactPage() {
  return (
    <div className="min-h-screen">
      {/* Header VERSION 3 - Mots-clés dynamiques */}
      <section className="bg-gradient-to-b from-neutral-grisClaire to-white py-24">
        <div className="container mx-auto px-4 text-center">
          <div className="inline-block mb-6">
            <span className="bg-sky-500 text-white px-6 py-2 text-sm font-bold uppercase tracking-wider rounded-full">
              Restons connectés
            </span>
          </div>
          <h1 className="text-7xl md:text-9xl font-black mb-6 leading-tight">
            <span className="text-neutral-anthracite">
              CONTACT
            </span>
            <br />
            <span className="bg-gradient-to-r from-sky-500 to-emerald-500 bg-clip-text text-transparent text-5xl md:text-7xl">
              & informations
            </span>
          </h1>
          <p className="text-xl md:text-2xl text-neutral-gris max-w-2xl mx-auto leading-relaxed">
            Votre paroisse est à votre écoute.<br />
            <span className="font-semibold text-neutral-anthracite">Parlons ensemble.</span>
          </p>
        </div>
      </section>
