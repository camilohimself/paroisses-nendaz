export default function ContactPage() {
  return (
    <div className="min-h-screen">
      {/* Header VERSION 1 - Jeu typographique */}
      <section className="bg-gradient-to-br from-sky-500 to-sky-600 text-white py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-6xl md:text-8xl font-black mb-6 leading-tight">
            ...
            <br />
            <span className="text-3xl md:text-5xl font-light tracking-wider opacity-90">& informations</span>
          </h1>
