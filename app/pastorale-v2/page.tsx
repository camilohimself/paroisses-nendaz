...
export default function PastoraleV2() {
  return (
      ...
      <div className="container mx-auto px-6 py-24">
        ...
        <div className="max-w-5xl mx-auto mb-28 text-center">
          ...
          <h1 className="text-8xl font-bold text-neutral-anthracite mb-10 tracking-tight leading-tight"
            ...
            La vie de chrétien<br />et ses groupes
          </h1>

          <p className="text-2xl text-neutral-gris leading-relaxed max-w-3xl mx-auto font-light">
            La vie chrétienne se déploie dans la prière commune, le service fraternel et l'engagement liturgique. Nos paroisses accueillent chacun selon ses charismes.
          </p>
        </div>
              ...
              <div className="flex-1 border-l-2 border-paroisse-bleuCiel pl-8 py-2">
                ...
                <div className="grid grid-cols-2 gap-6 mb-4">
                  <div>
                    ...
                    <p className="text-lg text-neutral-anthracite font-semibold">Mardi 18h00</p>
                  </div>
                  <div>
                    <p className="text-sm text-neutral-gris uppercase tracking-wider mb-1">Lieu</p>
                    <p className="text-lg text-neutral-anthracite font-semibold">Église de Basse-Nendaz</p>
                  </div>
                </div>
            ...
            <div className="flex items-start gap-8">
              ...
              <div className="flex-1 border-l-2 border-paroisse-vert pl-8 py-2">
                ...
                <div className="grid grid-cols-2 gap-6 mb-4">
                  <div>
                    <p className="text-sm text-neutral-gris uppercase tracking-wider mb-1">Horaire</p>
                    <p className="text-lg text-neutral-anthracite font-semibold">Jeudi 19h30</p>
                  </div>
                  <div>
                    <p className="text-sm text-neutral-gris uppercase tracking-wider mb-1">Lieu</p>
              ...
              <div className="flex-1 border-l-2 border-paroisse-jaune pl-8 py-2">
                ...
                <div className="grid grid-cols-2 gap-6 mb-4">
                  <div>
                    ...
                    <p className="text-lg text-neutral-anthracite font-semibold">Sur rendez-vous</p>
                  </div>
                  <div>
                    <p className="text-sm text-neutral-gris uppercase tracking-wider mb-1">Public</p>
                    <p className="text-lg text-neutral-anthracite font-semibold">Personnes âgées et malades</p>
                  </div>
                </div>
            ...
            <div className="flex items-start gap-8">
              ...
              <div className="flex-1 border-l-2 border-paroisse-bleuRoi pl-8 py-2">
                ...
                <div className="grid grid-cols-2 gap-6 mb-4">
                  <div>
                    <p className="text-sm text-neutral-gris uppercase tracking-wider mb-1">Public</p>
                    <p className="text-lg text-neutral-anthracite font-semibold">Enfants et jeunes (8-16 ans)</p>
                  </div>
                  <div>
                    <p className="text-sm text-neutral-gris uppercase tracking-wider mb-1">Formation</p>
                    <p className="text-lg text-neutral-anthracite font-semibold">Accompagnement régulier</p>
                  </div>
                </div>
            ...
            <div className="flex items-start gap-8">
              ...
              <div className="flex-1 border-l-2 border-paroisse-vert pl-8 py-2">
                ...
                <div className="grid grid-cols-2 gap-6 mb-4">
                  <div>
                    <p className="text-sm text-neutral-gris uppercase tracking-wider mb-1">Horaire</p>
                    <p className="text-lg text-neutral-anthracite font-semibold">Vendredi 20h00</p>
                  </div>
                  <div>
                    <p className="text-sm text-neutral-gris uppercase tracking-wider mb-1">Lieu</p>
                    <p className="text-lg text-neutral-anthracite font-semibold">Salle paroissiale</p>
                  </div>
                </div>
            ...
            <div className="flex items-start gap-8">
              ...
              <div className="flex-1 border-l-2 border-paroisse-jaune pl-8 py-2">
                ...
                <div className="grid grid-cols-2 gap-6 mb-4">
                  <div>
                    <p className="text-sm text-neutral-gris uppercase tracking-wider mb-1">Fréquence</p>
                    <p className="text-lg text-neutral-anthracite font-semibold">Réunions trimestrielles</p>
                  </div>
                  <div>
                    <p className="text-sm text-neutral-gris uppercase tracking-wider mb-1">Mission</p>
                    <p className="text-lg text-neutral-anthracite font-semibold">Orientation et conseil</p>
                  </div>
                </div>
